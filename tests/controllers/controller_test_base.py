...
from moderntreasury.configuration import Configuration
from moderntreasury.moderntreasury_client import (
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = ModerntreasuryClient(config=cls.config)
