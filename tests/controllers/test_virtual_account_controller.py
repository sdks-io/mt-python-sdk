...
class VirtualAccountControllerTests(ControllerTestBase):
    """
    ...
    def setUpClass(cls):
        ...
        """
        super().setUpClass()
        cls.controller = cls.client.virtual_account
        cls.response_catcher = cls.controller.http_call_back

    def test_list_virtual_accounts(self):
        """
        ...
        self.controller.list_virtual_accounts(
            after_cursor,
            per_page,
            internal_account_id,
            counterparty_id,
    ...
    def test_create_virtual_account(self):
        ...
        # Perform the API call through the SDK function
        self.controller.create_virtual_account(
            idempotency_key,
            body,
        )
        # Test response code
