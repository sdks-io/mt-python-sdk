...
class LedgerAccountStatementControllerTests(ControllerTestBase):
    """
    ...
    def setUpClass(cls):
        ...
        """
        super().setUpClass()
        cls.controller = cls.client.ledger_account_statement
        cls.response_catcher = cls.controller.http_call_back

    def test_create_ledger_account_statement(self):
        """
        ...
        self.controller.create_ledger_account_statement(
            idempotency_key,
            body,
        )
        # Test response code
