...
class ValidationApi(BaseApi):
    """A Controller to access Endpoints in the moderntreasury API."""

    def __init__(self, config):
        """Initialize ValidationApi object."""
        super(ValidationApi, self).__init__(config)
    ...
    def validate_routing_number(self,
        ...
        Args:
            ...
            routing_number_type (RoutingNumberType8): One of `aba`, `au_bsb`,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. successful valid
