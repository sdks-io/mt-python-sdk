...
from moderntreasury.models.reference_number_type_enum import (
...
class PaymentReference(object):
    ...
    Attributes:
        ...
        reference_number_type (ReferenceNumberTypeEnum): The type of the reference
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        ReferenceNumberTypeEnum.validate(value))
