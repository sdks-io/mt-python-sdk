...
from moderntreasury.models.payment_type_1_enum import (
    PaymentType1Enum,
)
from moderntreasury.models.routing_number_type_enum import (
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        RoutingNumberTypeEnum.validate(value)) \
                and APIHelper.is_valid_type(
                    value=dictionary.payment_type,
                    type_callable=lambda value:
                        PaymentType1Enum.validate(value),
                    is_value_nullable=True) \
                and APIHelper.is_valid_type(
