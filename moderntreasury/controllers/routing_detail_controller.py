...
class RoutingDetailController(BaseController):
    ...
    def __init__(self, config):
        """Initialize RoutingDetailController object."""
        super(RoutingDetailController, self).__init__(config)
    ...
    def list_routing_details(self,
        ...
        Args:
            accounts_type (AccountsTypeEnum): The request template parameter.
            account_id (str): The ID of the account.
            after_cursor (str, optional): The request query parameter.
            per_page (int, optional): The request query parameter.

        Returns:
            List[RoutingDetail]: Response from the API. successful
    ...
    def create_routing_detail(self,
        ...
        Args:
            accounts_type (AccountsType1Enum): The request template parameter.
            account_id (str): The ID of the account.
        ...
        Returns:
            RoutingDetail: Response from the API. successful
