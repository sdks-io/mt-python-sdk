...
class LedgerAccountStatementController(BaseController):
    ...
    def __init__(self, config):
        """Initialize LedgerAccountStatementController object."""
        super(LedgerAccountStatementController, self).__init__(config)
    ...
    def create_ledger_account_statement(self,
        ...
        Returns:
            LedgerAccountStatement: Response from the API. successful
