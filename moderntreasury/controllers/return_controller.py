...
class ReturnController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ReturnController object."""
        super(ReturnController, self).__init__(config)
    ...
    def list_returns(self,
        ...
        Args:
            ...
            returnable_type (ReturnableType1Enum, optional): One of `payment_order`,
                `paper_item`, `reversal`, or `incoming_payment_detail`. Must be
                accompanied by `returnable_id`.

        Returns:
            List[Return]: Response from the API. successful
    ...
    def create_return(self,
        ...
        Returns:
            Return: Response from the API. successful
