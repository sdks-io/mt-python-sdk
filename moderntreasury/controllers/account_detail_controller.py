...
class AccountDetailController(BaseController):
    ...
    def __init__(self, config):
        """Initialize AccountDetailController object."""
        super(AccountDetailController, self).__init__(config)
    ...
    def list_account_details(self,
        ...
        Returns:
            List[AccountDetail]: Response from the API. successful
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(AccountDetail.from_dictionary),
        ).execute()
    ...
    def create_account_detail(self,
        ...
        Args:
            ...
            body (AccountDetailCreateRequest, optional): The request body parameter.

        Returns:
            AccountDetail: Response from the API. successful
    ...
    def get_account_detail(self,
        ...
        Args:
            accounts_type (AccountsTypeEnum): The request template parameter.
            account_id (str): The ID of the account.
            id (str): The ID of the account detail.
