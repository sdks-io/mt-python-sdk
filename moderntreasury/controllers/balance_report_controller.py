...
class BalanceReportController(BaseController):
    ...
    def __init__(self, config):
        """Initialize BalanceReportController object."""
        super(BalanceReportController, self).__init__(config)
    ...
    def list_balance_reports(self,
        ...
        Args:
            ...
            balance_report_type (BalanceReportType1Enum, optional): The specific type
                of balance report. One of `intraday`, `previous_day`, `real_time`, or
                `other`.
            after_cursor (str, optional): The request query parameter.
            per_page (int, optional): The request query parameter.

        Returns:
            List[BalanceReport]: Response from the API. successful
    ...
    def get_balance_report(self,
        ...
        Returns:
            BalanceReport: Response from the API. successful
