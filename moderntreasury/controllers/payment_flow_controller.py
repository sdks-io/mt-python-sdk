...
from moderntreasury.models.payment_flow import (
    PaymentFlow,
)
...
class PaymentFlowController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PaymentFlowController object."""
        super(PaymentFlowController, self).__init__(config)
    ...
    def list_payment_flows(self,
        ...
        """Perform a GET request to /api/payment_flows.
        ...
        Args:
            ...
            receiving_account_id (str, optional): The request query parameter.
            originating_account_id (str, optional): The request query parameter.
            payment_order_id (str, optional): The request query parameter.

        Returns:
            List[PaymentFlow]: Response from the API. successful
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(PaymentFlow.from_dictionary),
        ).execute()

    def create_payment_flow(self,
                            idempotency_key=None,
                            body=None):
        """Perform a POST request to /api/payment_flows.

        Args:
            idempotency_key (str, optional): This key should be something unique,
                preferably something like an UUID.
            body (PaymentFlowCreateRequest, optional): The request body parameter.

        Returns:
            PaymentFlow: Response from the API. successful
    ...
    def get_payment_flow(self,
                         id,
                         idempotency_key=None):
        """Perform a GET request to /api/payment_flows/{id}.
    ...
    def update_payment_flow(self,
                            ...
                            idempotency_key=None,
                            body=None):
        """Perform a PATCH request to /api/payment_flows/{id}.

        Args:
            id (str): id
            idempotency_key (str, optional): This key should be something unique,
                preferably something like an UUID.
            body (PaymentFlowUpdateRequest, optional): The request body parameter.
