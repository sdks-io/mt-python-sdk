...
class TransactionLineItemController(BaseController):
    ...
    def __init__(self, config):
        """Initialize TransactionLineItemController object."""
        super(TransactionLineItemController, self).__init__(config)
    ...
    def list_transaction_line_items(self,
        ...
        Args:
            ...
            mtype (Type16Enum, optional): The request query parameter.
            per_page (int, optional): The request query parameter.

        Returns:
            List[TransactionLineItem]: Response from the API. successful
