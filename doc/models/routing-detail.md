...
| `payment_type` | [`PaymentType1Enum`](../../doc/models/payment-type-1-enum.md) | Required | If the routing detail is to be used for a specific payment type this field will be populated, otherwise null. |
