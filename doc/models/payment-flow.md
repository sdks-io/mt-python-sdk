...
| `status` | [`Status17`](../../doc/models/status-17.md) | Optional | The current status of the payment flow. One of `pending`, `completed`, `expired`, or `cancelled`. |
...
| `direction` | [`Direction9`](../../doc/models/direction-9.md) | Optional | Describes the direction money is flowing in the transaction. Can only be `debit`. A `debit` pulls money from someone else's account to your own. |
