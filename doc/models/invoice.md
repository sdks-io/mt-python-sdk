...
| `payment_type` | [`PaymentType5`](../../doc/models/payment-type-5.md) | Required | One of `ach` or `eft` |
| `payment_method` | [`PaymentMethod`](../../doc/models/payment-method.md) | Required | When opening an invoice, whether to show the embedded payment UI , automatically debit the recipient, or rely on manual payment from the recipient. |
