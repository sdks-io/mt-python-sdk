...
| `status` | [`Status7`](../../doc/models/status-7.md) | Optional | The status of the ledger account payout. It is set to `pending` by default. To post a ledger account payout at creation, use `posted`. |
