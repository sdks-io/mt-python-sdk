...
| `direction` | [`Direction15Enum`](../../doc/models/direction-15-enum.md) | Query, Optional | One of `credit` or `debit`. |
| `status` | [`Status21Enum`](../../doc/models/status-21-enum.md) | Query, Optional | The current status of the incoming payment order. One of `pending`, `completed`, or `returned`. |
| `mtype` | [`Type14Enum`](../../doc/models/type-14-enum.md) | Query, Optional | One of: `ach`, `book`, `check`, `eft`, `interac`, `rtp`, `sepa`, `signet`, or `wire`. |
...
[`List[IncomingPaymentDetail]`](../../doc/models/incoming-payment-detail.md)
...
[`IncomingPaymentDetail`](../../doc/models/incoming-payment-detail.md)
